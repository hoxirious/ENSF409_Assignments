Hao Nguyen: hao.nguyen@ucalgary.ca
Hy Huynh: hy.huynh@ucalgary.ca
...
Instrusction: Have 2 command prompt ready:
  ...
  - The second one you should run:
    ...
    + java Client
Note: This program uses Thread Pool but I set the maximum to 2 so this application can only run 2 clients at the same time.
