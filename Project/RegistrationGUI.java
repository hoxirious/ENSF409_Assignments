...
public class RegistrationGUI extends JFrame {
	...
	private void initComponents() {
		...
		courseName2TF = new JTextField(5);
		courseNum2TF = new JTextField(5);
		studentIdTF = new JTextField(5);
		secNumTF = new JTextField(5);
	...
	private void onActionListener() {
		...
		showStudentCoursesBtn.addActionListener((ActionEvent e) -> {
			...
			String result = JOptionPane.showInputDialog(this, "Please student's id: ", null);
